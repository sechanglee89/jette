        ...
        <footer>
          <div>
            ...
            <div className="text-wrap">
              ...
              <div>
                <a rel="noreferrer" href="https://smartstore.naver.com/cct7007" target="_blank"><p className="title store">제때 쇼핑몰</p></a>
                <a rel="noreferrer" href="https://naver.me/G0f17t7g" target="_blank"><p className="title location">농장 오시는 길</p></a>
                <p className="company-wrap">Copyright © 2023 Corallabs incorporated. <br className="mw-tag hide"/>All rights reserved.</p>
              </div>
            </div>
          </div>
        </footer>
